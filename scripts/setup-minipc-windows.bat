...
if exist "!CHROME!" (
    powershell -NoProfile -Command "$tv=[Uri]::EscapeDataString('!TV_LABEL!'); $url='http://92.5.28.167:4000/player?agencyId=!AGENCY_ID!'+[char]38+'tvId='+$tv; Start-Process '!CHROME!' -ArgumentList '--kiosk','--noerrdialogs','--disable-infobars','--disable-session-crashed-bubble',$url"
